...
PATHS = list(
  ...
  KOPPELHH = list(
    ...
    "2022" = "G:/InkomenBestedingen/KOPPELPERSOONHUISHOUDEN/KOPPELPERSOONHUISHOUDEN2022V1.sav"
  ),
  IHI = list(
  ...
  INHA = list(
    ...
    "2022" = "G:/InkomenBestedingen/INHATAB/INHA2022TABV1.sav"
  ),
  VEHTAB = list(
    ...
    "2022" = "G:/InkomenBestedingen/VEHTAB/VEH2022TABV1.sav"
  ),
  PARENT_TAB = "G:/Bevolking/KINDOUDERTAB/KINDOUDER2023TABV1.sav",
  HIGHEST_EDUCATION = list(
    ...
    "2022" = "G:/Onderwijs/HOOGSTEOPLTAB/2022/HOOGSTEOPL2022TABV1.sav"
  ),
